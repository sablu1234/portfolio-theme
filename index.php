...
<html lang="en">
    <head>
        ...
        <!-- <link rel="stylesheet" href="http://localhost/demo2/wp-content/themes/portfolio-theme/assets/css/style.css"> -->
...
?>
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        <li class="nav__item"><a href="#home" class="nav__link active-link">Home
            ...
            <section class="home bd-grid" id="home">
                ...
                <div class="home__img">
                    <svg class="home__blob" viewBox="0 0 479 467" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <g mask="url(#mask0)">
                            <path d="M9.19024 145.964C34.0253 76.5814 114.865 54.7299 184.111 29.4823C245.804 6.98884 311.86 -14.9503 370.735 14.143C431.207 44.026 467.948 107.508 477.191 174.311C485.897 237.229 454.931 294.377 416.506 344.954C373.74 401.245 326.068 462.801 255.442 466.189C179.416 469.835 111.552 422.137 65.1576 361.805C17.4835 299.81 -17.1617 219.583 9.19024 145.964Z"/>
                            <image class="home__blob-img" x="50" y="60" href="<?php echo get_parent_theme_file_uri('assets/img/perfil.png')?>"/>
                        </g>
                    </svg>
                </div>
            </section>
...
?>
            ...
            <section class="skills section" id="skills">
                ...
                <div class="skills__container bd-grid">          
                    ...
                    <div>              
                        <img src="<?php echo get_parent_theme_file_uri('assets/img/work3.jpg')?>" alt="" class="skills__img">
                    </div>
                </div>
            </section>
            ...
            <section class="work section" id="work">
                ...
                <div class="work__container bd-grid">
                    <a href="" class="work__img">
                        <img src="<?php echo get_parent_theme_file_uri('assets/img/work1.jpg')?>" alt="">
                    </a>
                    <a href="" class="work__img">
                       <img src=" <?php echo get_parent_theme_file_uri('assets/img/work2.jpg')?>">
                    </a>
                    <a href="" class="work__img">
                        <img src="<?php echo get_parent_theme_file_uri('assets/img/work3.jpg')?>" alt="">
                    </a>
                    <a href="" class="work__img">
                        <img src="<?php echo get_theme_file_uri('assets/img/work4.jpg')?>" alt="">
                    </a>
                    <a href="" class="work__img">
                        <img src="<?php echo get_theme_file_uri('assets/img/work5.jpg')?>" alt="">
                    </a>
                    <a href="" class="work__img">
                        <img src="<?php echo get_template_directory_uri().'/assets/img/work6.jpg';?>" alt="">
                    </a>
                </div>
            </section>
